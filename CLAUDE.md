# Marianita Klix Design System — Rules for AI Assistants

## Overview

This is the **Marianita Klix Design System**, a comprehensive UI kit with 61 components, design tokens, and multi-framework support. All code generated for this project MUST follow these rules.
...
All components use the `mk-` prefix:

```html
<button class="mk-btn mk-btn--primary mk-btn--md">Button</button>
<span class="mk-badge mk-badge--success">Active</span>
<input class="mk-input" placeholder="Enter text..." />
...
```html
<!-- Variants -->
<button class="mk-btn mk-btn--primary">Primary</button>
<button class="mk-btn mk-btn--secondary">Secondary</button>
<button class="mk-btn mk-btn--tertiary">Tertiary</button>
<button class="mk-btn mk-btn--destructive">Destructive</button>

<!-- Sizes -->
<button class="mk-btn mk-btn--primary mk-btn--sm">Small (32px)</button>
<button class="mk-btn mk-btn--primary mk-btn--md">Medium (40px)</button>
<button class="mk-btn mk-btn--primary mk-btn--lg">Large (48px)</button>
```

### Badge Variants

```html
<span class="mk-badge mk-badge--success">Success</span>
<span class="mk-badge mk-badge--error">Error</span>
<span class="mk-badge mk-badge--warning">Warning</span>
<span class="mk-badge mk-badge--brand">Brand</span>
<span class="mk-badge mk-badge--gray">Default</span>
```
...
```html
<!-- Input -->
<input class="mk-input" type="text" placeholder="Placeholder..." />
<input class="mk-input mk-input--error" type="text" />

<!-- Checkbox -->
<input type="checkbox" class="mk-checkbox" />

<!-- Toggle -->
<button class="mk-toggle" role="switch" aria-checked="false">
  <span class="mk-toggle__thumb"></span>
</button>

<!-- Select -->
<select class="mk-select">
...
<div class="mk-card">
  <div class="mk-card__header">
    ...
    <p class="mk-card__subtitle">Subtitle</p>
  </div>
  <div class="mk-card__body">Content</div>
  <div class="mk-card__footer">Actions</div>
</div>
```
...
2. **ALWAYS** use the `mk-` prefix for component classes
