#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
#  Marianita Klix Design System — MCP Setup Script
...
MCP_NAME="marianita-klix-design-system"
...
banner() {
  ...
  printf "  ╔══════════════════════════════════════════════════╗\n"
  printf "  ║                                                  ║\n"
  printf "  ║   🎬  Marianita Klix Design System — MCP Setup         ║\n"
  printf "  ║                                                  ║\n"
  printf "  ╚══════════════════════════════════════════════════╝\n"
  printf "${RESET}\n"
}
...
do_install() {
  ...
  printf "     ${CYAN}3.${RESET} Start building with the Marianita Klix Design System! 🎬\n"
  printf "\n"
...
do_uninstall() {
  banner
  printf "${YELLOW}${BOLD}  Removing Marianita Klix Design System MCP configuration...${RESET}\n\n"
